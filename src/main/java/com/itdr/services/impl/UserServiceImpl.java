...
import com.itdr.dao.impl.UserDaoImpl;
...
/*
    ...
    public ServerResponse login(HttpSession session, String username, String password) {
        ...
        //查找是否存在该用户
        int a=ud.selectByUname(username);
          if (a==0){
              //返回错误状态码和信息
              sr=ServerResponse.createServerResponseByError(
         ...
         return sr;
          ...
          //密码是否正确
         UserInfo ui =ud.selectByUnameAndPsd(username,password);
         if(ui==null){
             //返回错误状态码和信息
             sr=ServerResponse.createServerResponseByError(
    ...
    public ServerResponse forget_get_question(String username) {
        ...
        //该用户未设置找回密码问题
        UserInfo ui =ud.selectByUnameforquestion(username);
        if(ui.getQuestion().equals("")){
            //返回错误状态码和信息
            sr=ServerResponse.createServerResponseByError(
    ...
    public ServerResponse forget_check_answer(String username, String question, String answer) {
        ...
        //问题答案错误
        UserInfo ui =ud.selectByUnameforanswer(username,question);
        if(!(ui.getAnswer().equals(answer))){
            //返回错误状态码和信息
            sr=ServerResponse.createServerResponseByError(
